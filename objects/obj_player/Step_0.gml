...
if place_meeting(x + h_spd, y, obj_box_vertical)
	h_spd = 0

if place_meeting(x + h_spd, y, obj_box_horizontal)
{
	box_logic_x(instance_place(x + h_spd, y, obj_box_horizontal), h_spd)
	if place_meeting(x + h_spd, y, obj_box_horizontal)
		h_spd = 0
}
...
if place_meeting(x, y + v_spd, obj_box_horizontal)
	v_spd = 0

if place_meeting(x, y + v_spd, obj_box_vertical)
{
	box_logic_y(instance_place(x, y + v_spd, obj_box_vertical), v_spd)
	if place_meeting(x, y + v_spd, obj_box_vertical)
		v_spd = 0
}
